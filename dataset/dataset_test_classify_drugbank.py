...
class MolTestDataset(Dataset):
    def __init__(self, smiles):
        ...
        self.smiles_data, self.labels = read_smiles(smiles)
    ...
    def __getitem__(self, index):
        ...
        # data = Data(x=x, y=y, edge_index=edge_index, edge_attr=edge_attr) #改
...
class MolTestDatasetWrapper(object):
    ...
    def get_data_loaders(self, smiles):
        train_dataset = MolTestDataset(smiles=smiles)
        alldata = DataLoader(train_dataset, drop_last=False)
        return alldata
